...
class LoadAdmins 
{
            ...
            <div class="container">
                <div class="row" style="margin-top: 3rem;">
                    <div class="col s12">
                        <h5>Admin Account</h5>
                        <small>
                            Tabulated list of admins actively using the embedded POS/Book-keeping application.
                        </small>
                    </div>
        ...
        if(document.querySelectorAll('.userDetail'))
        {
            ...
            alluserDetailBtns.forEach(btn => {
                btn.addEventListener('click', e => {
                    ...
                    this.#loadSpecifiedAdminDetails(e.target);
                }, false);
            });
    ...
    #loadSpecifiedAdminDetails(elem)
    {
