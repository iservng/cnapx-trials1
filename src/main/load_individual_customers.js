...
class LoadIndividualCustomers 
{
    ...
    createUi(){
        if(this.#_mErrors == 0)
        {
            ...
            <div class="container">
                <div class="row" style="margin-top: 3rem;">
                    <div class="col s12">
                        ...
                        <small>
                            Tabulated list of individual customers actively using the embedded POS/Book-keeping application.
                        </small>
                    </div>
            ...
            this.#loadFirstListOfIndividual();
    ...
    async #loadFirstListOfIndividual()
    {
        ...
        if(document.querySelectorAll('.userDetail'))
        {
            ...
            alluserDetailBtns.forEach(btn => {
                btn.addEventListener('click', e => {
                    e.preventDefault();
                    this.#loadSpecifiedIndividualDetail(e.target);
                }, false);
            });
    ...
    #loadSpecifiedIndividualDetail(elem)
    {
...
export { LoadIndividualCustomers }