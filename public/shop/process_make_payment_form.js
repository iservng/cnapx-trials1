...
import { TransactionCompletedUi } from "./transaction_completed_ui.js";
...
class ProcessMakePaymentForm
{
    ...
    validatePayment()
    {
        if(this.#_mErrors == 0)
        {
            ...
            //After the above items are added to the DB, then show the success UI, that allows the user to either print reciept or cancel//new
            
            let transactionCompletedUi = new TransactionCompletedUi();
