...
import { ProcessMoneyOutForm } from "./process_money_out_form.js";
//import
class AddMoneyOutUi
{
    #_mErrors;
    ...
    createUi()
    {
        ...
        if(this.#_mErrors == 0)
        {
                        ...
                        <div class="row">
                            <div class="col s12">
                                ...
                                <div class="card-content">
                                    ...
                                    <p>
                                        <div class="row">
                                        <form class="col s12" id="add_money_out_form">
                                            ...
                                            <p>
                                                ...
                                                <input type="submit" class="btn purple" id="add_money_out_btn" value="Save">
             ...
             * ==========================
             */
            if(document.querySelector('#add_money_out_form'))
            {
                document.querySelector('#add_money_out_form').addEventListener('submit', e => {
                    e.preventDefault();
                    //Dynamically load the code that handler the processing of the form and pass the form object to it.//import
                    
                    let moneyInUi = new ProcessMoneyOutForm(e.target);
